...
type SmtpThemeKowabunga struct{}

// Name returns the name of the default theme
func (dt *SmtpThemeKowabunga) Name() string {
	return "default"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *SmtpThemeKowabunga) HTMLTemplate() string {
	return `
                                    ...
                                    <tr>
                                      {{ range $index, $cell := $row }}
                                        <td
                                          ...
                                          {{ end }}
                                        >
                                          {{ if (eq $index 0) }}<b>{{ end }}{{ $cell.Value }}{{ if (eq $index 0) }}</b>{{ end }}
                                        </td>
                                      {{ end }}
                                    </tr>
                                  {{ end }}
...
func (dt *SmtpThemeKowabunga) PlainTextTemplate() string {
